...
namespace AspNetCore.Security.CAS
{
    internal class CasHandler : RemoteAuthenticationHandler<CasOptions>
    {
        ...
        protected override async Task HandleChallengeAsync(AuthenticationProperties properties)
        {
            ...
            var authorizationEndpoint = $"{Options.CasServerUrlBase}/login";
            switch (Options.AuthenticationType)
            {
                case AthenticationType.Windows:
                    authorizationEndpoint = $"{authorizationEndpoint}?iwa=true&loginToCas=true&service={returnTo}";
                    break;
                default:
                    authorizationEndpoint = $"{authorizationEndpoint}?service={returnTo}";
                    break;
            }
